...
import com.riis.leafclassifier.adapter.ImageItemAdapter
import com.riis.leafclassifier.model.ImageItem
import com.riis.leafclassifier.tflite.Classifier
...
class MainActivity : AppCompatActivity() {
    ...
    fun openGallery(){
        //Opens the photo gallery for user selection
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(requestCode == REQUEST_CODE && resultCode == Activity.RESULT_OK){
            ...
            //scales the bitmap and retains aspect ratio
            val scaledBitmap = Utils.resize(image, INPUT_SIZE, INPUT_SIZE)
    ...
    //Starts the classifier to recognize the uploaded image
    private fun startClassifier(item: ImageItem){
        ...
        val classifier = Classifier(assets, "plant_leaf_classifier.tflite", "labels.txt", INPUT_SIZE)

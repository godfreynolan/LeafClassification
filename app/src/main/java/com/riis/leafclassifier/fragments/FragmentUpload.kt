package com.riis.leafclassifier.fragments
...
import com.riis.leafclassifier.R
import com.riis.leafclassifier.Utils
...
class FragmentUpload: Fragment() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(requestCode == REQUEST_CODE && resultCode == Activity.RESULT_OK){
            ...
            val item = ImageItem(Utils.resize(image, INPUT_SIZE, INPUT_SIZE))
